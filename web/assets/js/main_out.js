    ...
    */
    ...
    function drawStats() {
        ...
        const rows = [
            ...
            `${stats.info.pelletsEaten} pellets eaten`,
        ];
        let width = 0;
    ...
    function drawGame() {
        ...
        if (settings.showJoystick) {
          const JoySticks = byId('joyDiv');
          var joyParam = { "title": "joySticks", "internalFillColor": '#777', "externalStrokeColor": '#777', "internalStrokeColor": '#464646' };
